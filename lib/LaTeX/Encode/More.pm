...
LaTeX::Encode::More - Encode strings in LaTeX
...
This module is similar to LaTeX::Encode on CPAN, but works
with a much larger range of Unicode characters.

=head1 EXPORT

=head1 FUNCTIONS

=head2 latex_encode($text)
